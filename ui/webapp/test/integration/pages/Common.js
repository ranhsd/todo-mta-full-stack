sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/todo/demo/app", ".html");
		...
		return Opa5.extend("com.todo.demo.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/todo/demo/localService/mockserver"], function (mockserver) {
